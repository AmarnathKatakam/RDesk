...
urlpatterns = [
    ...
    path('leave/balance/', hrms_views.get_leave_balance, name='get_leave_balance'),
    path('leave/encash/', hrms_views.leave_encash, name='leave_encash'),
    path('leave/approve/', hrms_views.admin_approve_leave, name='leave_approve_alias'),
    path('leave/reject/', hrms_views.admin_reject_leave, name='leave_reject_alias'),
    ...
    path('admin/leave/<int:leave_request_id>/approve/', hrms_views.admin_approve_leave, name='admin_approve_leave_by_id'),
    path('admin/leave/<int:leave_request_id>/reject/', hrms_views.admin_reject_leave, name='admin_reject_leave_by_id'),
    path('admin/leave/pending/', hrms_views.admin_get_pending_leaves, name='admin_get_pending_leaves'),
    path('admin/leave/all/', hrms_views.admin_get_all_leaves, name='admin_get_all_leaves'),
    
    # HRMS - Document Vault
    path('documents/', hrms_views.get_documents, name='get_documents'),
